...
import DuplicationPopup from '../../SourceViewer/components/DuplicationPopup';
import {
  filterDuplicationBlocksByLine,
  getDuplicationBlocksForIndex,
  isDuplicationBlockInRemovedComponent,
} from '../../SourceViewer/helpers/duplications';
import {
  duplicationsByLine as getDuplicationsByLine,
  issuesByComponentAndLine,
} from '../../SourceViewer/helpers/indexing';
  ...
  async fetchIssueFlowSnippets() {
    ...
    try {
      ...
      if (this.mounted) {
        this.setState({
          loading: false,
          notAccessible: rsp.status === HttpStatus.Forbidden,
        });
      }
    }
  }
